package ss.com.mvprx.component.httpclient.okhttp;
...
public class OkHttpRequest<T> extends HttpRequest<T> {
    ...
    public OkHttpRequest(Method method, String endPointUrl, HashMap<String, String> queryStrings, HashMap<String, String> body, Class<T> responseType) {
